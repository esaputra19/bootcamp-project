...
<head>
    ...
    <title>Bootcamp CodingerCourse</title>
</head>
                ...
                <div class="col-lg-11 col-12">
                    <div class="row">
                        <div class="col-lg-6 col-12 copywriting">
                            <p class="story">
                                BELAJAR LANGSUNG DENGAN YANG AHLI
                            </p>
                            <h1 class="header">
                                Mulai Sekarang <span class="text-purple">Perjalanan <br> Karir Anda</span> Hari ini
                            </h1>
                            <p class="support">
                                Tanpa membutuhkan skill apapun <br> anda dapat menentukan jalur karir anda sendiri
                            </p>
                            <p class="cta">
                                <a href="#" class="btn btn-master btn-primary">
                                    Mulai
